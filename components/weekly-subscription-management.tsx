...
export function WeeklySubscriptionManagement() {
  ...
  const handleSaveMeal = async () => {
    ...
    const updatedMeal = await updateMealOption(editingMeal.id, {
      ...
      tagsEn: editingMeal.tagsEn,
      active: editingMeal.active,
      imageUrl: editingMeal.imageUrl ?? "",
      imageKey: editingMeal.imageKey ?? "",
      calories: editingMeal.calories,
      proteinGrams: editingMeal.proteinGrams,
      allergens: editingMeal.allergens,
      allergensEn: editingMeal.allergensEn,
      description: editingMeal.description,
      descriptionEn: editingMeal.descriptionEn,
      ...
      try {
        ...
        if (result?.mealOption) {
          createdOptions.push({
            ...
            tagsEn: result.mealOption.tagsEn || [],
            ...
            proteinGrams: result.mealOption.proteinGrams,
            allergens: result.mealOption.allergens,
            allergensEn: result.mealOption.allergensEn,
            description: result.mealOption.description,
            descriptionEn: result.mealOption.descriptionEn,
