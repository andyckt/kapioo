  ...
  const menuData = [
    {
      ...
      dayZh: "周一",
      meals: [
        { name: "蘑菇汤", calories: 60, hasIcon: false },
        { name: "浓厚白汁意式蘑菇鸡", calories: 210, hasIcon: true },
        { name: "冷拌羽衣甘蓝沙拉", calories: 78, hasIcon: true },
        { name: "意大利面", calories: 155, hasIcon: true },
      ],
      totalCalories: 503,
      tags: [
        { name: "西式低负担", icon: Heart },
    ...
    },
    {
      ...
      dayZh: "周二",
      meals: [
        { name: "酸菜排骨锅", calories: 142, hasIcon: false },
        { name: "日式照烧鸡腿肉", calories: 165, hasIcon: true },
        { name: "冬菇西兰花豆腐", calories: 80, hasIcon: true },
        { name: "补血紫米饭", calories: 112, hasIcon: true },
      ],
      totalCalories: 499,
      tags: [
        { name: "开胃 低脂", icon: Flame },
        { name: "满足感强", icon: Zap },
      ],
    ...
    },
    {
      ...
      dayZh: "周三",
      meals: [
        { name: "番茄肉末豆腐汤", calories: 152, hasIcon: true },
        { name: "高汤手切牛肉", calories: 135, hasIcon: false },
        { name: "蘑菇清蛋", calories: 90, hasIcon: true },
        { name: "补血紫米饭 + 玉米粒", calories: 137, hasIcon: false },
      ],
      totalCalories: 514,
      tags: [
        { name: "多种动植物蛋白", icon: Shield },
        { name: "营养全面", icon: Apple },
      ],
      color: "from-[#FBF7F2] to-[#F5EDE4]",
      accent: "brown1",
      gradient: "from-[#C2884E] to-[#D1A46C]",
    },
    {
      ...
      dayZh: "周四",
      meals: [
        { name: "冬阴功海鲜汤", calories: 50, hasIcon: false },
        { name: "BBQ烤鸡", calories: 185, hasIcon: true },
        { name: "青豆玉米粒", calories: 88, hasIcon: true },
        { name: "咖喱乌冬面", calories: 180, hasIcon: true },
      ],
      totalCalories: 503,
      tags: [
        { name: "丰富膳食纤维", icon: Leaf },
        { name: "抗氧化", icon: Shield },
      ],
      color: "from-[#F5EDE4] to-[#FBF7F2]",
      accent: "brown2",
      gradient: "from-[#D1A46C] to-[#C2884E]",
    },
    {
      ...
      dayZh: "周五",
      meals: [
        { name: "韩式牛肉丝汤", calories: 152, hasIcon: true },
        { name: "番茄锅烧牛滑嫩芋", calories: 118, hasIcon: true },
        { name: "小炒时蔬", calories: 82, hasIcon: false },
        { name: "补血紫米饭 + 烤玛咖南瓜", calories: 128, hasIcon: true },
      ],
      totalCalories: 480,
      tags: [
        { name: "高蛋白 低脂", icon: Zap },
        { name: "清爽 低卡", icon: Flame },
      ],
      color: "from-[#FBF7F2] to-[#F5EDE4]",
      accent: "brown1",
      gradient: "from-[#C2884E] to-[#D1A46C]",
    },
    {
      ...
      dayZh: "周日",
      meals: [
        { name: "香菇锅牛肉丸", calories: 135, hasIcon: false },
        { name: "香菇彩椒鸡丝", calories: 152, hasIcon: true },
        { name: "白菜豆炒口蘑", calories: 75, hasIcon: false },
        { name: "补血紫米饭", calories: 112, hasIcon: true },
      ],
      totalCalories: 472,
      tags: [
        { name: "增强免疫", icon: Shield },
        { name: "补铁强身", icon: Heart },
      ],
      color: "from-[#F5EDE4] to-[#FBF7F2]",
      accent: "brown2",
      gradient: "from-[#D1A46C] to-[#C2884E]",
