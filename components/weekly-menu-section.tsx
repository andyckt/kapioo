  ...
  const menuData = [
    {
      ...
      meals: [
        ...
        { name: "酸溜白菜", calories: 86, hasIcon: true, description: "" },
        { name: "玉米饭", calories: 124, hasIcon: true, description: "" },
      ],
      totalCalories: 501,
      tags: [
    ...
    },
    {
      ...
      meals: [
        ...
        { name: "烤彩椒西葫芦", calories: 112, hasIcon: true, description: "" },
        { name: "补血紫米饭", calories: 117, hasIcon: true, description: "" },
      ],
      totalCalories: 526,
      tags: [
    ...
    },
    {
      ...
      meals: [
        ...
        { name: "西红柿花菜", calories: 107, hasIcon: true, description: "" },
        { name: "绵密土豆泥", calories: 158, hasIcon: true, description: "" },
      ],
      totalCalories: 589,
      tags: [
