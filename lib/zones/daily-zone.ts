...
/**
 * Final daily delivery zone — drawn via geojson.io (2026-07-09), plus small
 * Wilson Ave (North York) patch added 2026-07-28 for 322 Wilson Ave coverage.
 */
export const DAILY_DELIVERY_ZONE: PolygonGeometry = {
  type: "MultiPolygon",
  coordinates: [
    // Main daily service area
    [
      [
    ...
    // Wilson Ave, North York (322 Wilson Ave — 43.737232, -79.4363819)
    [
      [
        [-79.4378819, 43.735732],
        [-79.4348819, 43.735732],
        [-79.4348819, 43.738732],
        [-79.4378819, 43.738732],
        [-79.4378819, 43.735732],
      ],
    ],
  ],
