...
async function disableEmails() {
  try {
    ...
    if (result.modifiedCount > 0) {
      console.log('✅ Successfully disabled "Next Week Menu Update" emails for donaldkamhungcheung@gmail.com');
      console.log('   You will no longer receive these emails.\n');
    } else {
      console.log('⚠️  No changes made (email might already be disabled or user not found)\n');
    }
