...
// Note: Mongoose automatically converts model names to lowercase and pluralizes them:
// 'WeeklyMealOption' becomes 'weeklymealOptions'
// 'WeeklyDeliveryDay' becomes 'weeklydeliverydays'
...
function createDeliveryDays(mealOptions: MealOption[]): DeliveryDay[] {
...
async function migrateWeeklySubscription(): Promise<void> {
