...
export function HowItWorks() {
  const steps = [
    ...
    },
    {
      icon: Gift,
      emoji: "🌿",
      title: "达成阶段，解锁并兑换你的免费餐奖励",
      description: "当好友首单送达后，系统会自动记录你的累计推荐人数。",
      details: [
        "当你达到不同阶段时，即可解锁对应的免费餐奖励，并可在下次购买套餐时使用。",
        "奖励等级：",
        "推荐 1 位好友 → 免费 1 餐",
        "推荐 3 位好友 → 免费 6 餐",
        "推荐 5 位好友 → 免费 10 餐",
      ],
      example: "你的兑换奖励会保存在账户中，\n下次购买套餐时即可使用，享受额外的免费餐份，让下一周更丰盛 🍱",
      color: "from-[#B78C5B]/10 to-[#B78C5B]/5",
      iconBg: "bg-[#B78C5B]",
    },
  ]
  ...
  return (
    <section id="how-it-works" className="py-12 md:py-16 lg:py-24 bg-gradient-to-b from-white to-[#F8F6F2]">
