  ...
  const menuData = [
    {
      ...
      date: "July 14",
      meals: [
        { name: "冬阴功海鲜汤", calories: 110, hasIcon: true, description: "" },
        { name: "蒜香烤鸡腿", calories: 232, hasIcon: true, description: "" },
        { name: "清炒时蔬", calories: 70, hasIcon: true, description: "" },
        { name: "烤南瓜 + 紫米饭", calories: 138, hasIcon: true, description: "" },
      ],
      totalCalories: 550,
      tags: [
        { name: "高蛋白增肌", icon: Shield },
        { name: "低脂轻负担", icon: Leaf },
      ],
    ...
    },
    {
      ...
      date: "July 15",
      meals: [
        { name: "香烤巴沙鱼", calories: 147, hasIcon: true, description: "" },
        { name: "菠菜手撕鸡", calories: 183, hasIcon: true, description: "" },
        { name: "烤时蔬", calories: 75, hasIcon: true, description: "" },
        { name: "藜麦饭", calories: 125, hasIcon: true, description: "" },
      ],
      totalCalories: 530,
      tags: [
        { name: "高铁护血", icon: Heart },
        { name: "低卡饱腹", icon: Zap },
      ],
    ...
    },
    {
      ...
      date: "July 16",
      meals: [
        { name: "冬瓜玉米汤", calories: 82, hasIcon: true, description: "" },
        { name: "剁椒蒸鸡", calories: 202, hasIcon: true, description: "" },
        { name: "豌豆炒腊肠", calories: 90, hasIcon: true, description: "" },
        { name: "烤红薯 + 紫米饭", calories: 138, hasIcon: true, description: "" },
      ],
      totalCalories: 512,
      tags: [
        { name: "利水消肿", icon: Shield },
        { name: "均衡能量", icon: Flame },
      ],
      color: "from-[#FBF7F2] to-[#F5EDE4]",
      accent: "brown1",
      gradient: "from-[#C2884E] to-[#D1A46C]",
    },
    {
      ...
      date: "July 17",
      meals: [
        { name: "白萝卜虾皮汤", calories: 86, hasIcon: true, description: "" },
        { name: "香烤牛肉串", calories: 218, hasIcon: true, description: "" },
        { name: "西兰花炒蘑菇", calories: 88, hasIcon: true, description: "" },
        { name: "紫米饭 + 玉米粒", calories: 117, hasIcon: true, description: "" },
      ],
      totalCalories: 509,
      tags: [
        { name: "高纤抗氧化", icon: Zap },
        { name: "高蛋白增肌", icon: Leaf },
      ],
      color: "from-[#F5EDE4] to-[#FBF7F2]",
      accent: "brown2",
      gradient: "from-[#D1A46C] to-[#C2884E]",
    },
    {
      ...
      date: "July 18",
      meals: [
        { name: "西红柿炒花菜", calories: 89, hasIcon: true, description: "" },
        { name: "京酱肉丝豆皮卷", calories: 237, hasIcon: true, description: "" },
        { name: "墨西哥烤玉米", calories: 60, hasIcon: true, description: "" },
        { name: "藜麦饭", calories: 125, hasIcon: true, description: "" },
      ],
      totalCalories: 511,
      tags: [
        { name: "养护心脏", icon: Heart },
        { name: "植物蛋白补充", icon: Shield },
      ],
      color: "from-[#FBF7F2] to-[#F5EDE4]",
      accent: "brown1",
      gradient: "from-[#C2884E] to-[#D1A46C]",
    },
    {
      ...
      date: "July 20",
      meals: [
        { name: "酸辣番茄鸡", calories: 175, hasIcon: true, description: "" },
        { name: "卤牛肉", calories: 165, hasIcon: true, description: "" },
        { name: "清炒时蔬", calories: 70, hasIcon: true, description: "" },
        { name: "藜麦饭", calories: 125, hasIcon: true, description: "" },
      ],
      totalCalories: 535,
      tags: [
        { name: "开胃促吸收", icon: Shield },
        { name: "补气养血", icon: Leaf },
      ],
      color: "from-[#FBF7F2] to-[#F5EDE4]",
      accent: "brown1",
