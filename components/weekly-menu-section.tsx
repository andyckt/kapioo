  ...
  const menuData = [
    {
      ...
      meals: [
        ...
        { name: "意式烤时令时蔬", calories: 100, hasIcon: true, description: "" },
        { name: "绵密土豆泥", calories: 160, hasIcon: true, description: "" },
      ],
      totalCalories: 515,
      tags: [
        { name: "优质蛋白", icon: Shield },
        { name: "低脂", icon: Leaf },
      ],
    ...
    },
    {
      ...
      meals: [
        ...
        { name: "小炒杂蔬", calories: 70, hasIcon: true, description: "" },
        { name: "补血紫米饭 + 玉米穗", calories: 137, hasIcon: true, description: "" },
      ],
      totalCalories: 507,
      tags: [
        { name: "高铁高蛋白", icon: Zap },
        { name: "丰富膳食纤维", icon: Heart },
      ],
    ...
    },
    {
      ...
      meals: [
        ...
        { name: "黑椒炙烤西兰花", calories: 75, hasIcon: true, description: "" },
        { name: "补血紫米饭", calories: 112, hasIcon: true, description: "" },
      ],
      totalCalories: 467,
      tags: [
        { name: "富含维C 抗氧化", icon: Shield },
        { name: "丰富口感", icon: Flame },
      ],
      color: "from-[#FBF7F2] to-[#F5EDE4]",
      accent: "brown1",
      gradient: "from-[#C2884E] to-[#D1A46C]",
    },
    {
      ...
      meals: [
        ...
        { name: "西红柿炒花菜", calories: 110, hasIcon: true, description: "" },
        { name: "补血紫米饭 + 妈咪南瓜", calories: 128, hasIcon: true, description: "" },
      ],
      totalCalories: 478,
      tags: [
        { name: "优质高蛋白", icon: Zap },
    ...
    },
    {
      ...
      meals: [
        ...
        { name: "墨西哥街头玉米沙拉", calories: 105, hasIcon: true, description: "" },
        { name: "墨西哥小卷", calories: 175, hasIcon: true, description: "" },
      ],
      totalCalories: 535,
      tags: [
    ...
    },
    {
      ...
      meals: [
        ...
        { name: "西式青豆", calories: 83, hasIcon: true, description: "" },
        { name: "烤土豆", calories: 135, hasIcon: true, description: "" },
      ],
      totalCalories: 513,
      tags: [
        { name: "蛋白质补给力强", icon: Shield },
        { name: "清爽低热", icon: Leaf },
      ],
      color: "from-[#FBF7F2] to-[#F5EDE4]",
      accent: "brown1",
